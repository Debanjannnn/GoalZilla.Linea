            ...
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Enter the total amount of Linea you want to raise for this campaign.
                </p>
              </div>
              <div>
                ...
                <div className="space-y-4 p-4 bg-gray-50 border-2 border-indigo-600 rounded-md">
                  {formData.milestones.map((milestone, index) => (
                    <div key={index} className="flex flex-col sm:flex-row gap-4">
                      ...
                      <div className="flex-1">
                        <label className="text-xs text-gray-500 mb-1 block">Target Amount (Linea )</label>
                        <Input
                          type="number"
                          placeholder="0.00"
                        ...
                        />
                        <p className="text-xxs text-gray-500 mt-1">
                          The amount of Linea needed to achieve this milestone. Total should equal your Funding Goal.
                        </p>
                      </div>
                      <Button
                        type="button"
